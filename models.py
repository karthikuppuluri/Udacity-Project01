...
class NearEarthObject:
    """A NearEarthObject encapsulates semantic and physical parameters.

    This includes the object's primary designation (required, unique), IAU name
    (optional), diameter in kilometers (optional), and whether it's marked as
    ...
    def __str__(self):
        ...
        return (f"NEO {self.fullname} {'is' if self.hazardous else 'is not'} "
                f"potentially hazardous.")
...
class CloseApproach:
    """A CloseApproach encapsulates information about NEO's close approach.

    This includes the date and time (in UTC) of closest approach, the nominal
    approach distance in astronomical units, and the relative approach velocity
    in kilometers per second.

    Attributes:
        time: The date and time, in UTC, at which the NEO passes closest to
              Earth
        distance: The nominal approach distance, in astronomical units, of the
                  NEO to Earth
        velocity: The velocity, in kilometers per second, of the NEO relative
                  to Earth
        neo: The NearEarthObject that is making a close approach to Earth
        designation: The primary designation of the close approach's NEO
    """
